                        ...
                        <section class="main-body-main-header">
                            ...
                            <div class="box margin-top-four">
                                <div class="box-header">
                                    <strong>ویرایش انبار</strong>
                                </div>
                                <div class="box-body">
                                    <form action="<?= ROOT_PATH.'repository/update/'.$data['repository']->id ?>" method="post">
                                        
                                          <label>نام انبار</label>
                                          <input type="text" class="input-main display-flex margin-auto" value="<?= $data['repository']->name ?>" name="name" placeholder="نام انبار را وارد کنید">


                                          <label>موقعیت انبار</label>
                                          <input type="text" class="input-main display-flex margin-auto" name="location" value="<?= $data['repository']->location ?>" placeholder="موقعیت انبار را وارد کنید">
